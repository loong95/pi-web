...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.plantUml": "PlantUML",
    "settings.plantUmlDescription": "Render PlantUML code blocks with your self-hosted PlantUML Server. No public server is used by default.",
    "settings.plantUmlServerUrl": "PlantUML Server URL",
    "settings.testPlantUmlConnection": "Test connection",
    "settings.testingPlantUml": "Testing connection…",
    "settings.clearPlantUmlServer": "Clear server",
    ...
    "settings.experimentalDescription": "Features that are still being worked out. They may change or be removed without notice.",
    "settings.worktreeSessions": "Session list",
    "settings.onlyCurrentWorktree": "Only show the current worktree",
    "settings.onlyCurrentWorktreeDescription": "Hide sessions from this project's other worktrees in the sidebar. Applies to every project.",
    "settings.autoTitle": "Auto session title",
    "settings.autoTitleDescription": "Experimental: once a session's first prompt finishes, its title is generated in the background. A failure is ignored, so the chat is unaffected and the button in the title bar keeps working.",
    "settings.autoTitleEnabled": "Generate a title after the first message",
    "settings.autoTitleModel": "Title model",
    "settings.autoTitleModelDescription": "Used for automatic and manual title generation. Leave it empty to reuse the model the session itself is using; if the chosen model becomes unavailable, naming falls back to it as well.",
    "settings.autoTitleModelSession": "Session model",
    "settings.autoTitleModelLoading": "Loading models…",
    "settings.autoTitleModelUnavailable": "{model} (unavailable)",
    "settings.autoTitleLoadFailed": "Could not load the title settings: {message}",
    "settings.autoTitleSaveFailed": "Could not save the title settings: {message}",
    ...
    "i18n.showPlantUmlSource": "Show PlantUML source",
    "i18n.previewPlantUml": "Preview PlantUML diagram",
    "i18n.renderingPlantUml": "Rendering PlantUML diagram",
    "i18n.plantUmlRenderFailed": "PlantUML rendering failed",
    "i18n.openPlantUmlViewer": "Open diagram viewer",
    "i18n.plantUmlViewer": "PlantUML diagram viewer",
    "i18n.plantUmlDiagram": "PlantUML diagram",
