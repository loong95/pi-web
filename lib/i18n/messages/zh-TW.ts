...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.plantUmlDescription": "使用您自架的 PlantUML Server 算繪 PlantUML 程式碼區塊；預設不使用公開伺服器。",
    "settings.plantUmlServerUrl": "PlantUML Server URL",
    "settings.testPlantUmlConnection": "測試連線",
    "settings.testingPlantUml": "正在測試連線…",
    "settings.clearPlantUmlServer": "清除伺服器",
    ...
    "settings.experimental": "實驗",
    "settings.experimentalDescription": "仍在摸索中的功能，可能隨時變更或移除。",
    "settings.worktreeSessions": "工作階段清單",
    "settings.onlyCurrentWorktree": "只顯示目前 worktree 的工作階段",
    "settings.onlyCurrentWorktreeDescription": "在側邊欄隱藏本專案其他 worktree 的工作階段，對所有專案生效。",
    "settings.autoTitle": "自動產生工作階段標題",
    "settings.autoTitleDescription": "實驗性功能：工作階段的第一則訊息完成後在背景產生標題。產生失敗會被忽略，不影響對話，標題列的手動產生按鈕仍可使用。",
    "settings.autoTitleEnabled": "第一則訊息後自動產生標題",
    "settings.autoTitleModel": "標題模型",
    "settings.autoTitleModelDescription": "自動與手動產生標題都使用此模型。留空則沿用工作階段目前使用的模型；所選模型無法使用時同樣回退至該模型。",
    "settings.autoTitleModelSession": "跟隨工作階段模型",
    "settings.autoTitleModelLoading": "正在載入模型…",
    "settings.autoTitleModelUnavailable": "{model}（無法使用）",
    "settings.autoTitleLoadFailed": "無法讀取標題設定：{message}",
    "settings.autoTitleSaveFailed": "無法儲存標題設定：{message}",
    "auth.prompt": "登入後繼續使用",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.loggingIn": "正在登入...",
    ...
    "i18n.showPlantUmlSource": "顯示 PlantUML 原始碼",
    "i18n.previewPlantUml": "預覽 PlantUML 圖表",
    "i18n.renderingPlantUml": "正在算繪 PlantUML 圖表",
    "i18n.plantUmlRenderFailed": "PlantUML 算繪失敗",
    "i18n.openPlantUmlViewer": "開啟圖表檢視器",
    "i18n.plantUmlViewer": "PlantUML 圖表檢視器",
    "i18n.plantUmlDiagram": "PlantUML 圖表",
